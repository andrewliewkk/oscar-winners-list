...
insert into winner values (31,'diane_keaton', 'F', "Diane Keaton", 1977, "Annie Hall", "Keaton won for her role as the title character in Woody Allen's Best Picture Oscar winner about the failed relationship between a comedian and an aspiring singer.");
...
insert into winner values (70,'sandra_bullock.jpg', 'F', "The Blind Side", 2009, "The Blind Side", "Bullock won her Oscar for playing Leigh-Anne Tuohy, a southern woman who adopts an impoverished black teenager and guides him to a successful NFL career.");
